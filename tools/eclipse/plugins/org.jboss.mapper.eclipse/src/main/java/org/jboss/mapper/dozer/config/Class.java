...
/**
 * 
 * Specifies one of the classes in the mapping definition. All Mapping definitions are bi-directional by default. Global
 * configuration and Mapping element values are inherited
 * 
 * Required Attributes:
 * 
 * Optional Attributes:
 * 
 * bean-factory The factory class to create data objects. This typically will not be specified. By default Dozer constructs new
 * instances of data objects by invoking the no-arg constructor
 * 
 * factory-bean-id The id passed to the specified bean factory
 * 
 * map-set-method For Map backed objects, this indicates which setter method should be used to retrieve field values. This should
 * only be used of Map backed objects.
 * 
 * map-get-method For Map backed objects, this indicates which getter method should be used to retrieve field values. This should
 * only be used of Map backed objects.
 * 
 * create-method Which method to invoke to create a new instance of the class. This is typically not specified. By default, the no
 * arg constructor(public or private) is used
 * 
...
public class Class {
     ...
     * factory-bean-id The id passed to the specified bean factory
     * 
     * map-set-method For Map backed objects, this indicates which setter method should be used to retrieve field values. This
     * should only be used of Map backed objects.
     * 
     * map-get-method For Map backed objects, this indicates which getter method should be used to retrieve field values. This
     * should only be used of Map backed objects.
     * 
     * create-method Which method to invoke to create a new instance of the class. This is typically not specified. By default, the
     * no arg constructor(public or private) is used
     * 
     * map-null Indicates whether null values are mapped. The default value is "true"
     * 
     * map-empty-string Indicates whether empty string values are mapped. The default value is "true"
     ...
     * 
     */
    public void setFactoryBeanId( final String value ) {
