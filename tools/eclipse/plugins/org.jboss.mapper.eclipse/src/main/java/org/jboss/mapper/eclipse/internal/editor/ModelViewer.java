...
class ModelViewer extends Composite {
    ...
    class LabelProvider extends StyledCellLabelProvider {
        ...
        private Image getImage( final Object element ) {
            ...
            if ( model.isCollection() ) return images.getImage( ISharedImages.IMG_FIELD_DEFAULT );
        ...
        public void update( final ViewerCell cell ) {
            ...
            if ( editor.mapped( ( Model ) element, rootModel ) ) text.append( "*", StyledString.DECORATIONS_STYLER );
