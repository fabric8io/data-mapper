...
/**
 * This class is a dirty hack to deal with two JAXB models (blueprint and spring) 
 * underneath our config layer.  The idea is to not expose the different package
 * names for the blueprint and spring models to the UI.  Best solution is 
...
public class CamelEndpoint {
    ...
    public CamelEndpoint(Object delegate) {
        if (delegate instanceof org.jboss.mapper.camel.spring.CamelEndpointFactoryBean) {
            ...
            blueprintEndpoint = (org.jboss.mapper.camel.blueprint.CamelEndpointFactoryBean)delegate;
        }
    }
